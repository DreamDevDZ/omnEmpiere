...
// This scripts registers the OmnEmpiere Service with EBAY. Run it after EBAY setup
// set  $developerID,$applicationID,$certificateID,$serverUrl='https://api.sandbox.ebay.com/ws/api.dll';
